...
public class wk7_gui {
	...
	private void initialize() {
		...
		btnAddCustomer.setHorizontalAlignment(SwingConstants.LEFT);
		...
		btnAddCustomer.setBounds(221, 73, 125, 23);
		...
		btnCreateCustomer.setHorizontalAlignment(SwingConstants.LEFT);
		...
		btnCreateCustomer.setBounds(5, 144, 140, 23);
		frame.getContentPane().add(btnCreateCustomer);
		
		JLabel lblAddress = new JLabel("Address");
		lblAddress.setBounds(10, 112, 48, 14);
