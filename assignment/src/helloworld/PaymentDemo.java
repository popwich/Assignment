...
public class PaymentDemo extends JPanel {
    //Default values
    private static double DEFAULT_AMOUNT = 1000;
    private static double DEFAULT_RATE = 3.5;  //3.5 %
    ...
    private static String amountString = "Principal Amount (1 - 10,000,000): ";
    private static String rateString = "APR (>= 0%): ";
    private static String numPeriodsString = "Years (1-40): ";
    private static String paymentString = "Total accrued amount: ";
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame("PaymentDemo");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        JComponent newContentPane = new PaymentDemo();
    ...
    //Compute the total payment based on the loan amount, rate and length of loan.
    double computePayment(double loanAmt, double rate, int numPeriods) {
    	return loanAmt * ( 1 + rate / 100 * numPeriods);    	    	
    }
